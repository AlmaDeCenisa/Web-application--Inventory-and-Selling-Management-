...
<head>
	...
	<title>Juguetes Didacticos Nelly</title>
			...
			<div class="container-fluid d-flex align-items-center justify-content-between">
				<div class="navbar-header">
					<!-- Navbar Header--><a href="index.php" class="navbar-brand">
						<div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Juguetes</strong><strong>Didacticos</strong></div>
						<div class="brand-text brand-sm"><strong class="text-primary">J</strong><strong>D</strong></div>
					</a>
					<!-- Sidebar Toggle Btn-->
